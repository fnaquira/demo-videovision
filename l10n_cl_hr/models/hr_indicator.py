...
class Indicator(models.Model):
    _name = 'hr.l10n_cl_hr.indicator'
    _description = 'Indicadores'

    state = fields.Selection([('draft','Borrador'), ('done','Validado')], string=u'Estado', readonly=True, default='draft')
    ...
    last_update_previred = fields.Datetime(string='Ultima actualización previred')
    ...
    sueldo_minimo_otro = fields.Float('Menores de 18 y Mayores de 65', readonly=True, states=STATES, help="Sueldo Mínimo para Menores de 18 y Mayores a 65")

    deposito_convenido = fields.Float('Deposito Convenido', readonly=True, states=STATES, help="Deposito Convenido")

    contrato_plazo_fijo_empleador = fields.Float('Contrato Plazo Fijo Empleador', readonly=True, states=STATES, help="Contrato Plazo Fijo Empleador")
    contrato_plazo_fijo_trabajador = fields.Float('Contrato Plazo Fijo Trabajador', readonly=True, states=STATES, help="Contrato Plazo Fijo Trabajador")
    contrato_plazo_indefinido_empleador = fields.Float('Contrato Plazo Indefinido Empleador', readonly=True, states=STATES, help="Contrato Plazo Fijo")
    contrato_plazo_indefinido_empleador_otro = fields.Float('Contrato Plazo Indefinido 11 anos o mas', readonly=True, states=STATES, help="Contrato Plazo Indefinido 11 anos Empleador")   
    contrato_plazo_indefinido_trabajador = fields.Float('Contrato Plazo Indefinido Trabajador', readonly=True, states=STATES, help="Contrato Plazo Indefinido Trabajador")
    contrato_plazo_indefinido_trabajador_otro = fields.Float('Contrato Plazo Indefinido 11 años o mas', readonly=True, states=STATES, help="Contrato Plazo Indefinido 11 años o mas")
    ...
    tasa_afp_habitat = fields.Float('Habitat', readonly=True, states=STATES, help="Tasa AFP Habitat")
    tasa_afp_uno = fields.Float('Uno', readonly=True, states=STATES, help="Tasa AFP Uno")
    ...
    tasa_sis_modelo = fields.Float('SIS', readonly=True, states=STATES, help="Tasa SIS Modelo")
    tasa_sis_uno = fields.Float('SIS', readonly=True, states=STATES, help="Tasa SIS Uno")
    ...
    tasa_independiente_modelo = fields.Float('SIS', readonly=True, states=STATES, help="Tasa Independientes Modelo")
    tasa_independiente_uno = fields.Float('SIS', readonly=True, states=STATES, help="Tasa Independientes Uno")

    asignacion_familiar_primer = fields.Float('Asignación Familiar Tramo 1', readonly=True, states=STATES, help="Asig Familiar Primer Tramo")
    asignacion_familiar_segundo = fields.Float('Asignación Familiar Tramo 2', readonly=True, states=STATES, help="Asig Familiar Segundo Tramo")
    asignacion_familiar_tercer = fields.Float('Asignación Familiar Tramo 3', readonly=True, states=STATES, help="Asig Familiar Tercer Tramo")
    ...
    dias_laborados = fields.Integer('Total días laborables', default=20)
    dias_feriados = fields.Integer('Total días feriados', default=4)
    ...
    def update_document(self):
        self.last_update_previred = datetime.today()
        try:
    ...
    def create_indicator_month(self):
        today = fields.Date.context_today(self)
        indicator_id = self.create({
            'name': 'Draft',
        ...
        indicator_id.get_name()
        indicator_id.update_document()
